...
<title>Web Page Update Demo</title>
  ...
  <style>
    ...
    .navbar {
      ...
      color: #FFFFFF;
      border-bottom: 10px solid #293578;
    }
    .fixed-top {
      position: fixed;
      top: 0;
  ...
  <body style="background-color: #7c878e" onload="process()">
  
    <header>
      <div class="navbar fixed-top">
          <div class="container">
            <div class="navtitle">Orthosie-I Demo</div>
    ...
    <main class="container" style="margin-top:80px">
      ...
      <colgroup>
        <col span="1" style="background-color:rgb(150,150,150); width: 30%; color:#000000 ;">
        <col span="1" style="background-color:rgb(180,180,180); width: 30%; color:#000000 ;">
        <col span="1" style="background-color:rgb(180,180,180); width: 30%; color:#000000 ;">
      </colgroup>
      ...
      <tr>
        <td><div class="bodytext">Analog pin 0</div></td>
        <td><div class="tabledata" id = "b0"></div></td>
        <td><div class="tabledata" id = "v0"></div></td>
      </tr>
      <tr>
        <td><div class="bodytext">Analog pin 1</div></td>
  ...
  <footer div class="foot" id = "temp" >Wurth Electronics Orthosie-1</div></footer>
